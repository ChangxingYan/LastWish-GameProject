...
public class DialogueSystem : MonoBehaviour
{
    ...
    void ReadExternalFile()
    {
        ...
        for (int i = 1; i < allLinesFromFile.Length; i++)
        {
            ...
            newLine.ghostControl = int.Parse(dialogueLineFromFile[4]);

            //this is a boolean and what is saved is whether that line is the same as "Y". If so, we have a true
            //otherwise, it is false
            newLine.lastEventInSequence = (dialogueLineFromFile[5] == "Y");


            //this will be the name of the file asset
            newLine.imgAsset = dialogueLineFromFile[6];            
            ...
            newLine.audioAsset = dialogueLineFromFile[7].TrimEnd('\r', '\n', '\t');            
